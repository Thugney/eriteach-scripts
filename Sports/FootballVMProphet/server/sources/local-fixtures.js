...
export function loadFixtures(rootDir) {
  ...
  try {
    ...
    if (parsed.dataQuality === 'seed') {
      health.warnings.push('Fixture file is seed data. Replace with official FIFA 2026 fixtures when available.');
    }
    return {
      tournament: parsed.tournament || { name: 'FIFA World Cup 2026' },
